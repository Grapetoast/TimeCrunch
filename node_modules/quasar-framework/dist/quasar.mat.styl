...
$dot-opacity           ?= .8
$dot-size              ?= 10px
$dot-position-top      ?= 8px
$dot-position-right    ?= 4px
...
$layout-aside-left-width   ?= 300px
$layout-aside-right-width  ?= 300px
$layout-header-shadow      ?= $shadow-4
$layout-footer-shadow      ?= $shadow-up-4
$layout-aside-shadow       ?= $shadow-8
